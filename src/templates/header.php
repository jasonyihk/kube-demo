<header class="header {{ header_class }}">
  ...
  <div class="vertical-center-container ">
    ...
    <div class="header-navbar-container collapse navbar-collapse vertical-center pull-right">
      <ul class="header-right-navbar-container nav navbar-nav desktop-header">
        ...
        <li class="nav-item small-item header-right-navbar-item-lang dropdown">
          ...
          <ul class="header-navbar-item-dropdown dropdown-menu">
            ...
            <li class="header-navbar-item-dropdown-itemsmall">
              <a href="../../fr/{{ locale_path }}/" class="ga-click-tracking" data-ga-label="fr">Français</a>
            </li>
          </ul>
        </li>
        <li class="nav-item small-item">
      ...
      <ul class="header-mobile-navbar-container nav navbar-nav">
        ...
        <li class="nav-item mobile dropdown">
          ...
          <ul class="dropdown-menu mobile dropdown-submenu">
            ...
            <li class="nav-item">
              <a class="ga-click-tracking" data-ga-label="about_infinitus" href="../about-infinitus/" data-toggle="collapse" data-target=".header-navbar-container">{{ 'about.item.0'|trans }}</a>
            </li>
            <li class="nav-item">
              <a class="ga-click-tracking" data-ga-label="corporate_culture" href="../corporate-culture/" data-toggle="collapse" data-target=".header-navbar-container">{{ 'about.item.1'|trans }}</a>
            </li>
            <li class="nav-item">
              <a class="ga-click-tracking" data-ga-label="milestone" href="../milestone/" data-toggle="collapse" data-target=".header-navbar-container">{{ 'about.item.2'|trans }}</a>
            </li>
            <li class="nav-item">
              <a class="ga-click-tracking" data-ga-label="r_and_d" href="../research-and-development/" data-toggle="collapse" data-target=".header-navbar-container">{{ 'about.item.3'|trans }}</a>
            </li>
            <li class="nav-item">
        ...
        <li class="nav-item mobile dropdown">
          ...
          <ul class="dropdown-menu mobile dropdown-submenu">
            ...
            <li class="nav-item">
              <a class="ga-click-tracking" data-ga-label="fr" href="../../fr/{{ locale_path }}/" data-toggle="collapse" data-target=".header-navbar-container">Français</a>
            </li>
          </ul>
        </li>
        ...
        <li class="footer-item">
          <a class="ga-click-tracking" data-ga-label="faq" href="{{ 'contact-us.url'|trans }}" target="_blank">{{ 'contact-us.text'|trans }}</a>
        </li>
        <li class="footer-item">
    ...
    <div class="header-center-container collapse vertical-center desktop-header pull-right">
