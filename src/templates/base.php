...
<html prefix="og: http://ogp.me/ns#" lang="{{ locale }}">
  <head>
    ...
    <meta property="og:image" itemprop="image" content="{{ baseMetaUrl }}{{ (image_Facebook)|trans }}">
    <meta property="og:image:width" content="470">
    <meta property="og:image:height" content="246">
    <meta property="og:image" itemprop="image" content="{{ baseMetaUrl }}{{ (image_Google)|trans }}">
    <meta property="og:image:width" content="426">
    <meta property="og:image:height" content="426">
    <meta property="og:image" itemprop="image" content="{{ baseMetaUrl }}{{ (image_WeChat)|trans }}">
    <meta property="og:image:width" content="300">
    <meta property="og:image:height" content="300">
    <meta property="og:image" itemprop="image" content="{{ baseMetaUrl }}{{ (image_Whatsapp)|trans }}">
    <meta property="og:image:width" content="300">
    ...
    <meta name="twitter:image" content="{{ baseMetaUrl }}{{ (image_Twitter)|trans }}">
